...
- (void)viewDidLoad {
    ...
    RBLine *line1 = [[RBLine alloc] initWithHandler:^(RBLine *line) {
        line.pointWidth = 5;
        line.lineColor = [UIColor colorWithRed:0.095 green:0.744 blue:0.911 alpha:1.000];
        line.lineWidth = 2.;
        line.values = @[@10, @80, @90, @78, @98, @79, @87];
        line.lineNode = [[RBLineSolidNode alloc] initWithHandler:^(RBLineSolidNode *node) {
    ...
    RBLine *line2 = [[RBLine alloc] initWithHandler:^(RBLine *line) {
        line.pointWidth = 5;
        line.lineColor = [UIColor colorWithRed:0.911 green:0.902 blue:0.169 alpha:1.000];
        line.lineWidth = 2.;
        line.values = @[@20, @60, @40, @98, @70, @65, @30];;
        line.lineNode = [[RBLineSolidNode alloc] initWithHandler:^(RBLineSolidNode *node) {
            node.strokeColor = [UIColor colorWithRed:0.911 green:0.902 blue:0.169 alpha:1.000];
            node.fillColor = [UIColor colorWithRed:0.911 green:0.902 blue:0.169 alpha:1.000];
            node.nodeWidth = 5;
        }];
    }];
    
    RBLineChartDecorator *chartDecorator = [[RBLineChartDecorator alloc] initWithHandler:^(RBLineChartDecorator *decorator) {
        decorator.boardBackgroundColor = [UIColor colorWithRed:0.300 green:0.382 blue:0.715 alpha:1.000];
        decorator.leading = 20;
        decorator.elements = @[line1, line2];
        decorator.maxValue = 120;
    }];
    chart.decorator = chartDecorator;
